<%@ Page Title="" Language="C#" MasterPageFile="~/WearDrop1.Master" AutoEventWireup="true" CodeBehind="RegistrarVentaBoleta.aspx.cs" Inherits="WearDropWA.RegistrarVentaBoleta" %>
...
<div class="header-box">
    <h2 id="lblTitulo" runat="server">Registrar Boleta</h2>
    ...
    <div class="buttons-bottom-container">
        ...
        <asp:Button ID="btnRegistrarVenta" runat="server" Text="Registrar Venta" CssClass="btn" OnClick="btnRegistrarVenta_Click" />
    </div>
