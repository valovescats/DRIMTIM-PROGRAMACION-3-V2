    ...
    <div class="container">
        ...
        <div class="descuento-container">
            ...
            <div class="form-field">
                ...
                <input type="text" id="nombreDescuento" placeholder="Nombre de la promocion" />
            </div>

            <!-- Campo Porcentaje -->
            <div class="form-field">
                <label for="porcentajePromocion">Porcentaje Promocion (*)</label>
                <input type="text" id="porcentajePromocion" placeholder="Porcentaje Promoción" />
            </div>
