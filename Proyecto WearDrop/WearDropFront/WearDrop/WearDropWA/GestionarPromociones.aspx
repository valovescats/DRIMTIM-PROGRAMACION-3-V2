<%@ Page Title="Gestionar Promociones" Language="C#" MasterPageFile="~/WearDrop1.Master" AutoEventWireup="true" CodeBehind="GestionarPromociones.aspx.cs" Inherits="WearDropWA.GestionarPromociones" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Seleccionar Tipo de Promoción a  Gestionar:
</asp:Content>
    ...
    <div class="container">
                ...
                <div class="col-md-6 p-0">
                    <div class="header-title">
                        <div class="title-section">
                            <h2>Seleccionar el Tipo de Promocion a Gestionar: </h2>
                        </div>
        ...
        <div class="container row mt-4">
            <div class="button-container">
              <%-- <button id="btnConjunto" runat="server" onserverclick="btnConjunto_ServerClick" class="promo-button green">
                <i class="fa-solid fa-tags"></i><span>CONJUNTO</span>
                </button>


                <button id="btonCombo" runat="server" onserverclick="btnCombo_ServerClick" class="promo-button soft-red">
                  <i class="fa-solid fa-dollar-sign"></i><span>COMBO</span>
                </button>--%>
                <button id="btnConjunto" runat="server" onserverclick="btnConjunto_ServerClick" class="promo-button green">
                <div class="inner"><i class="fa-solid fa-tags"></i><span>CONJUNTO</span></div>
                </button>

                        
            <button id="btonCombo" runat="server" onserverclick="btnCombo_ServerClick" class="promo-button soft-red">
            <div class="inner"><i class="fa-solid fa-dollar-sign"></i><span>COMBO</span></div>
            </button>
