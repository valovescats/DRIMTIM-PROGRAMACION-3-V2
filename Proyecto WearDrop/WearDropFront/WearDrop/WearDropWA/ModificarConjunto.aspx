    ...
    <div class="container">
        ...
        <div class="row mt-5">
            <div class="col-md-8">
                ...
                <!-- Ubicacion -->
                <div class="mb-4">
                    <asp:Label ID="lblPorcentaje" runat="server" Text="Porcentaje Promocion " CssClass="form-label"></asp:Label>
                    <asp:TextBox ID="txtPorcentaje" runat="server" CssClass="form-control" placeholder="Placeholder text"></asp:TextBox>
                </div>
