<%@ Page Title="" Language="C#" MasterPageFile="~/WearDrop1.Master" AutoEventWireup="true" CodeBehind="ListarPorcentaje.aspx.cs" Inherits="WearDropWA.ListarPorcentaje" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    .custom-grid th {
        background-color: #C0D2E2 !important;
        color: #333333;
        font-weight: 500;
        padding: 15px 20px;
        text-align: left;
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <div class="container row">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 p-0">
                    <div class="header-title">
                        <div class="title-section">
                            <h2>Gestionar Descuentos Porcentajes</h2>
                        </div>
                ...
                <div class="col text-end p-3">
                    <asp:LinkButton ID="lkRegistrar" CssClass="btn" Style="background-color:  #A0B4C5; color: #FFFFFF; border-color: #73866D; margin-right: 20px" runat="server" OnClick="lkRegistrar_Click" Text="Registrar Descuento" />
                    <asp:LinkButton ID="lkFiltrar" CssClass="btn" Style="background-color:  #A0B4C5; color: #FFFFFF; border-color: #73866D" runat="server" OnClick="lkFiltrar_Click" Text="Filtrar" />
                </div>
            </div>
        </div>
        <div class="container row mt-4">
            ...
            <asp:GridView ID="gvPorcentajes" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="True"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Porcentaje Promocion" DataField="Porcentaje Promocion"/>
