<%@ Page Title="" Language="C#" MasterPageFile="~/WearDrop1.Master" AutoEventWireup="true" CodeBehind="ListarLiquidacion.aspx.cs" Inherits="WearDropWA.ListarLiquidacion" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
                ...
                <div class="col-md-6 p-0">
                    <div class="header-title">
                        <div class="title-section">
                            <h2>Gestionar Descuentos Liquidaciones</h2>
                        </div>
        ...
        <div class="container row mt-4">
            ...
            <asp:GridView ID="gvLiquidaciones" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="True"
