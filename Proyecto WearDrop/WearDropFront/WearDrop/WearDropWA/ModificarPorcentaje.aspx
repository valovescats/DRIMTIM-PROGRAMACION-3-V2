    ...
    <div class="container">
        ...
        <div class="row mt-5">
            <div class="col-md-8">
                ...
                <div class="mb-4">
                    <asp:Label ID="lblPorcentajePromocion" runat="server" Text="Porcentaje Promocion" CssClass="form-label"></asp:Label>
                    <asp:TextBox ID="txtPorcentajePromocion" runat="server" CssClass="form-control" placeholder="Placeholder text"></asp:TextBox>
                </div>
