<%@ Page Title="" Language="C#" MasterPageFile="~/WearDrop1.Master" AutoEventWireup="true" CodeBehind="ListarMonto.aspx.cs" Inherits="WearDropWA.ListarMonto" %>
                ...
                <div class="col-md-6 p-0">
                    <div class="header-title">
                        <div class="title-section">
                            <h2>Gestionar Descuentos Monto</h2>
                        </div>
        ...
        <div class="container row mt-4">
            ...
            <asp:GridView ID="gvMonto" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="True"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Monto Editable" DataField="Monto Editable"/>
                    <asp:BoundField HeaderText="Monto Máximo" DataField="Monto Máximo"/>
                    <asp:TemplateField>
                        <ItemTemplate>
